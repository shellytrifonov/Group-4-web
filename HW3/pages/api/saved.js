/**
 * API Route Handler - Manages saved recipes for users.
 * 
 * Supported Methods:
 * - GET: Fetch all saved recipes for a given user, sorted by creation date.
 * - DELETE: Remove a specific recipe from a user's saved list.
 * 
